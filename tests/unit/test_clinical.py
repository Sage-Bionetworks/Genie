...
def test_missingcols__validate():
	...
	expected_warnings = ("Patient: Must have YEAR_DEATH column for 7...release uploads.\n"
						 ...
						 "Patient: Must have DEAD column for 7...release uploads.\n"
					  	 "Patient: clinical file doesn't have PRIMARY_RACE column. A blank column will be added\n"
