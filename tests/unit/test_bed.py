...
def test_perfect___process():
	...
	expected_beddf = pd.DataFrame(dict(Chromosome =['2', '9', '12','19','19'],
	...
	new_beddf = bed_class._process(beddf, seq_assay_id, new_path, parentid, createPanel=False)
...
def test_includeinpanel___process():
	...
	expected_beddf = pd.DataFrame(dict(Chromosome =['2', '9', '12','19'],
