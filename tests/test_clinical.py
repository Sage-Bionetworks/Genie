...
def test_nonull__validate():
    ...
    with mock.patch(
        ...
        expected_errors = (
            ...
            "Please double check your BIRTH_YEAR "
            "column, it must be an integer in YYYY format <= {year} or "
            "'Unknown', '>89', '<18'.\n"
            "Please double check your YEAR_DEATH "
            "column, it must be an integer in YYYY format <= {year} or "
            "'Unknown', 'Not Collected', 'Not Applicable', "
            "'Not Released', '>89', '<18'.\n"
            "Please double check your YEAR_CONTACT "
            "column, it must be an integer in YYYY format <= {year} or "
...
def test_missingcols__validate():
    ...
    with mock.patch(
        ...
        mock_get_onco_map.called_once_with(json_oncotreeurl)
        expected_errors = (
            "Must have BIRTH_YEAR column.\n"
            "Must have YEAR_DEATH column.\n"
            "Must have YEAR_CONTACT column.\n"
