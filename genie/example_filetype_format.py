...
class FileTypeFormat(object):
    ...
    def preprocess(self, filePath, **kwargs):
        '''
        This is for any preprocessing that has to occur to obtain kwargs for processing.
    ...
    def _validate(self, df, **kwargs):
        ...
        Returns:
            tuple: The errors and warnings as a file from validation. Defaults to blank strings
        '''
        total_error = ""
        warning = ""
