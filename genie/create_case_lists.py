...
def write_case_list_files(clinical_file_map, output_directory, study_id):
    for cancer_type, ids in iteritems(clinical_file_map):
        ...
        case_list_file = open(
            os.path.abspath(
                output_directory + '/' + 'case_list_' +
                cancer_type_no_spaces + '.txt'),
            'w')
...
def write_case_list_cna(cna_samples, output_directory, study_id):
    case_list_file = open(
        os.path.abspath(output_directory + '/' + 'case_list_cna.txt'), 'w')
...
def write_case_list_cnaseq(cna_samples, output_directory, study_id):
    case_list_file = open(
        os.path.abspath(output_directory + '/' + 'case_list_cnaseq.txt'), 'w')
...
def create_case_lists(
        clinical_file_name, gene_matrix_file_name, output_directory, study_id):
...
def main(clinical_file_name,
    ...
    Main function
    '''
    create_case_lists(clinical_file_name,
                      gene_matrix_file_name,
                      output_directory,
                      study_id)
