...
The GENIE retraction policy states that if a sample/patient is implicitly or explicitly after the first 3 months of a public release, it should be retracted from the public release.  To assist with this, we ask centers to confirm the retracted samples listed in this file: `r paste0("https://www.synapse.org/#!Synapse:", ent$properties$id)` . Centers should only have samples here if someone has withdrew consent - If you have samples/patients in this table that should not be on here, please upload a fix to your data or let Tom Yu from Sage know immediately.
