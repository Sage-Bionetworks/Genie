...
plotPrimarySites <- function(clinical, oncotreeLink, release) { 
  ...
  barplot(toPlot,col=c("red","blue","light green","pink","purple","black","lavender","yellow"), width=2, beside=F, las=2,ylab="Number of Samples",main="Primary Site Distribution (Top 50 Counts)", ylim=c(0,ceiling(maxValue * 1.0 / 1000) * 1000))
...
plotCancerType <- function(this_samples) {
  ...
  barplot(toPlot, las = 2,cex.names = 0.8, ylab = "Fraction of samples",col = brewer.pal(8,"Spectral"),legend.text = rownames(typeCountsByCen),main="Fractional sample counts, per center and type")
}
