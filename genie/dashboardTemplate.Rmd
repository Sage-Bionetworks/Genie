...
* `num_genes_submitted`: number of unique genes a panel has prior to remapping
* `num_genes_expected`: number of unique genes a panel should have submitted by each center 
