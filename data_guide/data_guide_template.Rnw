...
library_selection <- ggplot(assayinfodf, aes(library_selection)) +
  geom_bar() +
  theme_bw() +
  labs(x = "Library Selection", y = "# of Panels")
library_strategy <- ggplot(assayinfodf, aes(library_strategy)) +
  geom_bar() +
  theme_bw() +
  labs(x = "Library Strategy", y = "# of Panels")

platform <- ggplot(assayinfodf, aes(platform)) +
  geom_bar() +
  theme_bw() +
  labs(x = "Platform", y = "# of Panels")
calling_strategy <- ggplot(assayinfodf, aes(calling_strategy)) +
  geom_bar() +
  theme_bw() +
  labs(x = "Calling Strategy", y = "# of Panels")
specimen_tumor_cellularity <- ggplot(assayinfodf,
                                     aes(specimen_tumor_cellularity)) +
  geom_bar() +
  theme_bw() +
  labs(x = "Specimen Tumor Cellularity", y = "# of Panels")
...
@
\end{center}
\caption{Distribution of library selection, library strategy, platform, calling strategy, and specimen tumor cellularity across pipelines}
\end{figure}
...
<<results=tex, echo=F>>=
allowed_specimen_types = c("FFPE", 'fresh_frozen', "formalin_fixed")

specimen_per_panel = get_list_assay_info_table(allowed_specimen_types,
                                               assayinfodf,
                                               "specimen_type")
# TODO: Remove this line later
specimen_per_panel <- specimen_per_panel[,c('FFPE', 'fresh_frozen')]
