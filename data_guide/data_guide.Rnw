...
- Variants that failed MuTect's internal filters due to 'nearby\_gap\_events' and 'poor\_mapping\_-regional\_alternate\_allele\_mapq' were removed.\\
...
Princess Margaret Cancer Centre used four (4) panels to sequence samples for the GENIE 6.1-publicrelease -UHN-48-V1, UHN-50-V2, UHN-2-V,UHN-54-V1, and UHN-555-V1.  Each panel is described below:\\\\
...
1-VHIO\_GENERAL\_v01: Panel containing 56 oncogenes andtumor suppressor genes;\\
2-VHIO\_BRAIN\_v01 (General + NF1 v1: 57 genes);\\
3-VHIO\_BILIARY\_v01 (General + *FGFR v1 + **NOTCH v1: 59 genes);\\
4-VHIO\_COLORECTAL\_v01 (General + RingFingers v1 + **NOTCH v1: 60 genes);\\
5-VHIO\_HEAD\_NECK\_v1 (General + MTOR v1 + **NOTCH v1: 61 genes);\\
6-VHIO\_ENDOMETRIUM\_v01 (General + RingFingers v1 + *FGFR v1 + NF1 v1: 60 genes);\\
7-VHIO\_GASTRIC\_v01 (General + RingFingers v1 + MTOR v1 + **NOTCH v1: 63 genes);\\
8-VHIO\_PAROTIDE\_v01 (General + **NOTCH v1: 58 genes);\\
9-VHIO\_BREAST\_v01 (General + *FGFR v1 + **NOTCH v1+ GATA3 v1: 60 genes);\\
10-VHIO\_OVARY\_v01 (General + BRCA v1: 58 genes);\\
11-VHIO\_PANCREAS\_v01 (General + Ring Fingers v1 + BRCA v1: 60 genes);\\
12-VHIO\_SKIN\_v01 (General + NF1 v1 + MTOR v1: 60 genes);\\
13-VHIO\_LUNG\_v01 (General + NF1 v1 + MET v1 + FGFRw7 v1: 58);\\
14-VHIO\_KIDNEY\_v01 (General + MTOR v1: 59 genes);\\
15-VHIO\_URINARY\_BLADDER\_v01 (General + *FGFR v1 + NF1 v1 + MTOR v1: 61 genes).\\\\
