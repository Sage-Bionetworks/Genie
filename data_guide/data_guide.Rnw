...
<<results=tex, echo=F>>=
info_tab = xtable(assayinfo$asDataFrame()[,c("SEQ_ASSAY_ID", "platform", 
                                             "library_strategy", "library_selection",
                                             "instrument_model",
                                             "specimen_type", "specimen_tumor_cellularity")],
                  caption = 'Genomic Data Characterization')
#cat("\\makebox[\\textwidth]{")
print(info_tab, include.rownames = F, floating = F, size = "\\tiny",
      caption.placement = "top", tabular.environment = "longtable")
# cat("}")
#cat("\\endgroup")
...
\textbf{\href{https://www.cruk.cam.ac.uk/}{Duke Cancer Institute} (DUKE)}\\

\textbf{\href{https://www.cruk.cam.ac.uk/}{Institut Gustave Roussy} (GRCC)}\\

\textbf{\href{https://www.cruk.cam.ac.uk/}{The University of Texas MD Anderson Cancer Center} (MDA)}\\

\textbf{\href{https://www.cruk.cam.ac.uk/}{Memorial Sloan Kettering Cancer Center} (MSK)}\\

\textbf{\href{https://www.cruk.cam.ac.uk/}{Johns Hopkins Sidney Kimmel Comprehensive Cancer Center} (JHU)}\\

\textbf{\href{https://www.cruk.cam.ac.uk/}{Netherlands Cancer Center}, The Netherlands (NKI)}\\


\textbf{\href{https://www.cruk.cam.ac.uk/}{Providence Health \& Services Cancer Institute} (PHS)}\\


\textbf{\href{https://www.cruk.cam.ac.uk/}{Swedish Cancer Institute} (SCI)}\\


\textbf{\href{https://www.cruk.cam.ac.uk/}{Princess Margaret Cancer Centre}, University Health Network (UHN)}\\


\textbf{\href{https://www.cruk.cam.ac.uk/}{Vall d'Hebron Institute of Oncology} (VHIO)}\\

\textbf{\href{https://www.cruk.cam.ac.uk/}{Vanderbilt-Ingram Cancer Center} (VICC)}\\


\textbf{\href{https://www.cruk.cam.ac.uk/}{Wake Forest University Health Sciences}  (Wake Forest Baptist Medical Center) (WAKE)}\\
...
Contributing GENIE centers provided mutation data in Variant Call Format (VCF vcf2maf v1.6.17, samtools.github.io/hts-specs) or Mutation Annotation Format (GDC MAF v1.0.0, https://docs.gdc.cancer.gov/Data/File\_Formats/MAF\_Format/) with additional fields for read counts supporting variant alleles, reference alleles, and total depth. Some “MAF-like” text files with minimal required columns (https://github.com/mskcc/vcf2maf/blob/v1.6.17/data/minimalist\_test\_maf.tsv) were also received from the participating centers. These various input formats were converted into a complete tab-separated MAF format, with a standardized set of additional columns (https://github.com/mskcc/vcf2maf/blob/v1.6.17/docs/vep\_maf\_readme.txt) using either vcf2maf or maf2maf v1.6.17 (https://github.com/mskcc/vcf2maf/tree/v1.6.17) wrappers around the Variant Effect Predictor (VEPv86, https://github.com/mskcc/vcf2maf/blob/v1.6.17/docs/vep\_maf\_readme.txt). The vcf2maf “custom-enst” option overrode VEP’s canonical isoform for most genes, with Uniprot’s canonical isoform (https://github.com/mskcc/vcf2maf/blob/v1.6.17/data/isoform\_overrides\_uniprot).\\\\
