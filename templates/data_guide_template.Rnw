...
The resulting MAF filtered by the gnomAD allele frequency (AF) columns.  If any variant had a gnomAD subpopulation AF of 0.0005 or greater, it was considered a germline variant and filtered out.  This 0.0005 threshold was selected because it tagged no more than 1\% of the somatic calls across all MSK-IMPACT samples with patient-matched controls.\\\\
