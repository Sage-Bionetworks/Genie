...
not_dnp <- substr(this_mut$Reference_Allele[is_dnp], 1, 1) == substr(this_mut$Tumor_Seq_Allele2[is_dnp], 1, 1) |
...
not_onp<-substr(this_mut$Reference_Allele[is_onp], 1, 1) == substr(this_mut$Tumor_Seq_Allele2[is_onp], 1, 1) |
