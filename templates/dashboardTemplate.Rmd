...
not_dnp <- this_mut[
  substr(this_mut$Reference_Allele[is_dnp], 1, 1) == substr(this_mut$Tumor_Seq_Allele2[is_dnp], 1, 1) |
  substr(this_mut$Reference_Allele[is_dnp], 1, 2) == substr(this_mut$Tumor_Seq_Allele2[is_dnp], 1, 2),
]
if (nrow(not_dnp) > 0) {
...
not_onp <- this_mut[
  substr(this_mut$Reference_Allele[is_onp], 1, 1) == substr(this_mut$Tumor_Seq_Allele2[is_onp], 1, 1) |
  substr(this_mut$Reference_Allele[is_onp], 1, 2) == substr(this_mut$Tumor_Seq_Allele2[is_onp], 1, 2),
]
