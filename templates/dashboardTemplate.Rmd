...
mafdb = synTableQuery(sprintf('select Hugo_Symbol, Center, Chromosome, Tumor_Sample_Barcode, HGVSp_Short from %s where filter_variant is true', maf_synid),
                      includeRowIdAndRowVersion = F)
mafdbdf = mafdb$asDataFrame()
mafdbdf = mafdb[mafdb$Tumor_Sample_Barcode %in% this_samples$SAMPLE_ID, ]
