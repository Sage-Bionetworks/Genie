...
## Flagged Mutations
This is a count of how many flagged mutations a center has. Most of these variants are potential artifacts flagged by manual review of cBioPortal. These variants have been removed from the data. Please inform Sage Bionetworks about:
...
```{r invalid_variant_type, echo=F, include=F}
...
if (nrow(invalid_dnp) > 0) {
  write.csv(invalid_dnp[,c("Hugo_Symbol", "Chromosome", "Reference_Allele",
...
if (nrow(invalid_onp) > 0) {
  write.csv(invalid_onp[, c("Hugo_Symbol", "Chromosome", "Reference_Allele",
                            "Tumor_Seq_Allele2", "Tumor_Sample_Barcode",
                            "Variant_Type")],
