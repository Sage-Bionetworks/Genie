...
not_dnp <- substr(this_mut[is_dnp]$Reference_Allele,1, 1) == substr(this_mut[is_dnp]$Tumor_Seq_Allele2, 1, 1) | 
           substr(this_mut[is_dnp]$Reference_Allele, 1, 2) == substr(this_mut[is_dnp]$Tumor_Seq_Allele2, 1, 2)
if (nrow(not_dnp) > 0) {
...
not_onp<-substr(this_mut[is_onp]$Reference_Allele, 1, 1) == substr(this_mut[is_onp]$Tumor_Seq_Allele2, 1, 1) | 
         substr(this_mut[is_onp]$Reference_Allele, 1, 2) == substr(this_mut[is_onp]$Tumor_Seq_Allele2, 1, 2)
